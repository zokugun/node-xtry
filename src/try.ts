...
export function xtry<T, E = unknown>(func: AsyncIterableCallback<T> | Callback<T> | SyncIterableCallback<T>, handler?: ErrorHandler<E>): AsyncIterableResult<T, E> | MaybePromise<VoidableResult<T, E>> | SyncIterableResult<T, E> { // {{{
	try {
...
export function xtryAsyncIterable<T, E = unknown>(iterable: (() => MaybePromise<AsyncIterable<T>>) | AsyncIterable<T> | Promise<AsyncIterable<T>>, handler?: ErrorHandler<E>): AsyncIterable<VoidableResult<T, E>> { // {{{
	const generator = typeof iterable === 'function' ? iterable : (): AsyncIterable<T> | Promise<AsyncIterable<T>> => iterable;
